...
import { parseOne } from "./src/services/Report/index.js";
import { Unzipper } from "./src/services/Unzipper/Unzip.js";
import { ReadStringifyReport } from "./src/services/Report/ReadStringifyReport.js";
...
const readDirectoryJob = false; // is first job must be excecuted
...
const fileName = 'CRSANR5L16S2021O1N144.xml';
const filePath = `${LOCAL_FILES_PATHS}/syseron/${fileName}`;

AppDataSource.initialize().then(async () => {
  Report.parseOne(filePath)
